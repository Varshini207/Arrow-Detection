...
# test image
q=input("enter path of testing image")
image = cv2.imread(r"C:\Users\Varsh\Desktop\testleftarrow.jpg")
gray_image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
histogram = cv2.calcHist([gray_image], [0], 
                         None, [256], [0, 256])
 
# data1 image
image = cv2.imread(r"C:\Users\Varsh\Desktop\right arrow.jpg")
gray_image1 = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
histogram1 = cv2.calcHist([gray_image1], [0], 
                          None, [256], [0, 256])
 
# data2 image
image = cv2.imread(r"C:\Users\Varsh\Desktop\left arrow.jpg")
